    ...
    <div className="w-full max-w-sm">
      ...
      {magicSent ? (
        <div className="bg-card border border-border rounded-2xl p-6 text-center space-y-3">
          ...
          <button onClick={() => setMagicSent(false)} className="text-xs text-muted-foreground hover:text-foreground transition-colors">
      ...
      <p className="text-center text-xs text-muted-foreground mt-6">
        <a href="/" className="hover:text-foreground transition-colors">← Back to public assistant</a>
      </p>
    </div>
  )
}
